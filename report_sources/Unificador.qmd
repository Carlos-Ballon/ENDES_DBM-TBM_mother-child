...
```{r}
individual_data_1_2024 <- rio::import(here::here("data", "2024","RECH1_2024.dta"))

individual_data_2_2024 <- rio::import(here::here("data", "2024","RE516171_2024.dta"))
...
```{r}
individual_data_2019 <- rio::import(here::here("data", "2019","RECH1_2019.sav"))

home_data_2019 <- rio::import(here::here("data", "2019", "RECH0_2019.sav"))

dwelling_data_2019 <- rio::import(here::here("data", "2019", "RECH23_2019.sav"))
```

```{r}
woman_data_1_2019 <- rio::import(here::here("data", "2019", "RECH5_2019.sav"))

woman_data_2_2019 <- rio::import(here::here("data", "2019", "REC0111_2019.sav"))

woman_data_3_2019 <- rio::import(here::here("data", "2019", "REC41_2019.sav"))

woman_data_4_2019 <- rio::import(here::here("data", "2019", "REC42_2019.sav"))

woman_data_5_2019 <- rio::import(here::here("data", "2019", "RE223132_2019.sav"))
```

```{r}
children_data_1_2019 <- rio::import(here::here("data", "2019", "RECH6_2019.sav"))

children_data_2_2019 <- rio::import(here::here("data", "2019", "REC44_2019.sav"))

children_data_3_2019 <- rio::import(here::here("data", "2019", "REC43_2019.sav"))
```

```{r}
health_data_2019 <- rio::import(here::here("data", "2019", "CSALUD01_2019.sav"))
```

## 2018

```{r}
individual_data_2018 <- rio::import(here::here("data", "2018","RECH1_2018.sav"))

home_data_2018 <- rio::import(here::here("data", "2018", "RECH0_2018.sav"))

dwelling_data_2018 <- rio::import(here::here("data", "2018", "RECH23_2018.sav"))
```

```{r}
woman_data_1_2018 <- rio::import(here::here("data", "2018", "RECH5_2018.sav"))

woman_data_2_2018 <- rio::import(here::here("data", "2018", "REC0111_2018.sav"))

woman_data_3_2018 <- rio::import(here::here("data", "2018", "REC41_2018.sav"))

woman_data_4_2018 <- rio::import(here::here("data", "2018", "REC42_2018.sav"))

woman_data_5_2018 <- rio::import(here::here("data", "2018", "RE223132_2018.sav"))
```

```{r}
children_data_1_2018 <- rio::import(here::here("data", "2018", "RECH6_2018.sav"))

children_data_2_2018 <- rio::import(here::here("data", "2018", "REC44_2018.sav"))

children_data_3_2018 <- rio::import(here::here("data", "2018", "REC43_2018.sav"))
```

```{r}
health_data_2018 <- rio::import(here::here("data", "2018", "CSALUD01_2018.sav"))
```

## 2017

```{r}
individual_data_2017 <- rio::import(here::here("data", "2017","RECH1_2017.sav"))

home_data_2017 <- rio::import(here::here("data", "2017", "RECH0_2017.sav"))

dwelling_data_2017 <- rio::import(here::here("data", "2017", "RECH23_2017.sav"))
```

```{r}
woman_data_1_2017 <- rio::import(here::here("data", "2017", "RECH5_2017.sav"))

woman_data_2_2017 <- rio::import(here::here("data", "2017", "REC0111_2017.sav"))

woman_data_3_2017 <- rio::import(here::here("data", "2017", "REC41_2017.sav"))

woman_data_4_2017 <- rio::import(here::here("data", "2017", "REC42_2017.sav"))

woman_data_5_2017 <- rio::import(here::here("data", "2017", "RE223132_2017.sav"))
```

```{r}
children_data_1_2017 <- rio::import(here::here("data", "2017", "RECH6_2017.sav"))

children_data_2_2017 <- rio::import(here::here("data", "2017", "REC44_2017.sav"))

children_data_3_2017 <- rio::import(here::here("data", "2017", "REC43_2017.sav"))
```

```{r}
health_data_2017 <- rio::import(here::here("data", "2017", "CSALUD01_2017.sav"))
```
...
individual_data_2024 <- individual_data_1_2024 |> # Curado
...
## Normalization of identifiers 2019

```{r}
# Individual data_2019
individual_data_2019 <- individual_data_2019 |> # Curado
  dplyr::mutate(QSNUMERO = HVIDX) # Número de orden en el hogar

# Woman data_2019
woman_data_1_2019 <- woman_data_1_2019 |> 
  dplyr::mutate(QSNUMERO = HA0) # Número de orden en el hogar

woman_data_2_2019 <- woman_data_2_2019 |>
  dplyr::mutate(
    QSNUMERO = str_sub(CASEID, -2, -1),
    QSNUMERO = as.numeric(QSNUMERO)) # Número de orden en el hogar

woman_data_3_2019 <- woman_data_3_2019 |> # Esta une niños
  dplyr::mutate(
    HIDX = MIDX, # Orden de historia de nacimiento
    HHID = str_sub(CASEID, 1, str_length(CASEID) - 3), # Código del hogar
    QSNUMERO = str_sub(CASEID, -2, -1),
...
woman_data_4_2019 <- woman_data_4_2019 |>
  dplyr::mutate(
    HHID = str_sub(CASEID, 1, str_length(CASEID) - 3), # Código del hogar
    QSNUMERO = str_sub(CASEID, -2, -1),
    QSNUMERO = as.numeric(QSNUMERO) # Número de orden en el hogar
...
woman_data_5_2019 <- woman_data_5_2019 |>
  dplyr::mutate(
    HHID = str_sub(CASEID, 1, str_length(CASEID) - 3), # Código del hogar
    QSNUMERO = str_sub(CASEID, -2, -1),
    QSNUMERO = as.numeric(QSNUMERO)  # Número de orden en el hogar
...
# Children data_2019
children_data_1_2019 <- children_data_1_2019 |> #
  dplyr::mutate(
    HW1 = HC1,
    HW2 = HC2,
    HW3 = HC3,
...
children_data_2_2019 <- children_data_2_2019 |>
  dplyr::mutate(
    HIDX = HWIDX, # Orden de historia de nacimiento
    HHID = str_sub(CASEID, 1, str_length(CASEID) - 3), # Código del hogar
    QSNUMERO = str_sub(CASEID, -2, -1),
...
children_data_3_2019 <- children_data_3_2019 |>
  dplyr::mutate(
    HIDX = HIDX, # Orden de historia de nacimiento
    HHID = str_sub(CASEID, 1, str_length(CASEID) - 3), # Código del hogar
    QSNUMERO = str_sub(CASEID, -2, -1),
...
## Normalization of identifiers 2018

```{r}
# Individual data_2018
individual_data_2018 <- individual_data_2018 |> # Curado
  dplyr::mutate(QSNUMERO = HVIDX) # Número de orden en el hogar

# Woman data_2018
woman_data_1_2018 <- woman_data_1_2018 |> 
  dplyr::mutate(QSNUMERO = HA0) # Número de orden en el hogar

woman_data_2_2018 <- woman_data_2_2018 |>
  dplyr::mutate(
    QSNUMERO = str_sub(CASEID, -2, -1),
    QSNUMERO = as.numeric(QSNUMERO)) # Número de orden en el hogar

woman_data_3_2018 <- woman_data_3_2018 |> # Esta une niños
  dplyr::mutate(
    HIDX = MIDX, # Orden de historia de nacimiento
    HHID = str_sub(CASEID, 1, str_length(CASEID) - 3), # Código del hogar
    QSNUMERO = str_sub(CASEID, -2, -1),
...
woman_data_4_2018 <- woman_data_4_2018 |>
  dplyr::mutate(
    HHID = str_sub(CASEID, 1, str_length(CASEID) - 3), # Código del hogar
    QSNUMERO = str_sub(CASEID, -2, -1),
    QSNUMERO = as.numeric(QSNUMERO) # Número de orden en el hogar
...
woman_data_5_2018 <- woman_data_5_2018 |>
  dplyr::mutate(
    HHID = str_sub(CASEID, 1, str_length(CASEID) - 3), # Código del hogar
    QSNUMERO = str_sub(CASEID, -2, -1),
    QSNUMERO = as.numeric(QSNUMERO)  # Número de orden en el hogar
...
# Children data_2018
children_data_1_2018 <- children_data_1_2018 |> #
  dplyr::mutate(
    HW1 = HC1,
    HW2 = HC2,
    HW3 = HC3,
...
children_data_2_2018 <- children_data_2_2018 |>
  dplyr::mutate(
    HIDX = HWIDX, # Orden de historia de nacimiento
    HHID = str_sub(CASEID, 1, str_length(CASEID) - 3), # Código del hogar
    QSNUMERO = str_sub(CASEID, -2, -1),
...
children_data_3_2018 <- children_data_3_2018 |>
  dplyr::mutate(
    HIDX = HIDX, # Orden de historia de nacimiento
    HHID = str_sub(CASEID, 1, str_length(CASEID) - 3), # Código del hogar
    QSNUMERO = str_sub(CASEID, -2, -1),
...
## Normalization of identifiers 2017

```{r}
# Individual data_2017
individual_data_2017 <- individual_data_2017 |> # Curado
  dplyr::mutate(QSNUMERO = HVIDX) # Número de orden en el hogar

# Woman data_2017
woman_data_1_2017 <- woman_data_1_2017 |> 
  dplyr::mutate(QSNUMERO = HA0) # Número de orden en el hogar

woman_data_2_2017 <- woman_data_2_2017 |>
  dplyr::mutate(
    QSNUMERO = str_sub(CASEID, -2, -1),
    QSNUMERO = as.numeric(QSNUMERO)) |> # Número de orden en el hogar
  rename(HHID=hhid)

woman_data_3_2017 <- woman_data_3_2017 |> # Esta une niños
  dplyr::mutate(
    HIDX = MIDX, # Orden de historia de nacimiento
    HHID = str_sub(CASEID, 1, str_length(CASEID) - 3), # Código del hogar
    QSNUMERO = str_sub(CASEID, -2, -1),
...
woman_data_4_2017 <- woman_data_4_2017 |>
  dplyr::mutate(
    HHID = str_sub(CASEID, 1, str_length(CASEID) - 3), # Código del hogar
    QSNUMERO = str_sub(CASEID, -2, -1),
    QSNUMERO = as.numeric(QSNUMERO) # Número de orden en el hogar
...
woman_data_5_2017 <- woman_data_5_2017 |>
  dplyr::mutate(
    HHID = str_sub(CASEID, 1, str_length(CASEID) - 3), # Código del hogar
    QSNUMERO = str_sub(CASEID, -2, -1),
    QSNUMERO = as.numeric(QSNUMERO)  # Número de orden en el hogar
...
# Children data_2017
children_data_1_2017 <- children_data_1_2017 |> #
  dplyr::mutate(
    HW1 = HC1,
    HW2 = HC2,
    HW3 = HC3,
...
children_data_2_2017 <- children_data_2_2017 |>
  dplyr::mutate(
    HIDX = HWIDX, # Orden de historia de nacimiento
    HHID = str_sub(CASEID, 1, str_length(CASEID) - 3), # Código del hogar
    QSNUMERO = str_sub(CASEID, -2, -1),
...
children_data_3_2017 <- children_data_3_2017 |>
  dplyr::mutate(
    HIDX = HIDX, # Orden de historia de nacimiento
    HHID = str_sub(CASEID, 1, str_length(CASEID) - 3), # Código del hogar
    QSNUMERO = str_sub(CASEID, -2, -1),
...
children_mother_individual_data_2024 <- children_mother_data_2024 |>
  dplyr::left_join(individual_data_1_2024, by = c("HHID","QSNUMERO"))
...
## Join dataframes 2019

```{r}
# Join mother data_2019
woman_data_2019 <- woman_data_1_2019 |>
  dplyr::left_join(woman_data_2_2019, by = c("HHID", "QSNUMERO")) |>
  dplyr::left_join(woman_data_4_2019, by = c("HHID", "QSNUMERO")) |>
  dplyr::left_join(woman_data_5_2019, by = c("HHID", "QSNUMERO"))

# Join children data_2019
children_data_2019 <- children_data_1_2019 |>
  dplyr::full_join(children_data_2_2019, by = c("HHID", "QSNUMERO")) |>
  dplyr::left_join(children_data_3_2019, by = c("HHID", "QSNUMERO", "HIDX"))

# Join children data with mother data_2019
children_mother_data_2019 <- children_data_2019 |>
  dplyr::left_join(woman_data_3_2019, by = c("HHID", "QSNUMERO", "HIDX"))

# Join home data with dwelling data_2019
home_dwelling_data_2019 <- home_data_2019 |>
  dplyr::left_join(dwelling_data_2019, by = "HHID")

# Join children/mother data with individual data_2019
children_mother_individual_data_2019 <- children_mother_data_2019 |>
  dplyr::left_join(individual_data_2019, by = c("HHID","QSNUMERO"))

# Join home/dwelling/individual data with mother data_2019
pre_data_2019 <- children_mother_individual_data_2019 |> 
  dplyr::left_join(woman_data_2019, by = c("HHID", "QSNUMERO"))

# Join home/dwelling/individual/mother data with health data_2019
pre_data_1_2019 <- pre_data_2019 |> 
  dplyr::left_join(health_data_2019, by = c("HHID", "QSNUMERO"))

# Join all_2019
endesdbm_2019 <- pre_data_1_2019 |>
  dplyr::left_join(home_dwelling_data_2019, by = 'HHID')
```

## Join dataframes 2018

```{r}
# Join mother data_2018
woman_data_2018 <- woman_data_1_2018 |>
  dplyr::left_join(woman_data_2_2018, by = c("HHID", "QSNUMERO")) |>
  dplyr::left_join(woman_data_4_2018, by = c("HHID", "QSNUMERO")) |>
  dplyr::left_join(woman_data_5_2018, by = c("HHID", "QSNUMERO"))

# Join children data_2018
children_data_2018 <- children_data_1_2018 |>
  dplyr::full_join(children_data_2_2018, by = c("HHID", "QSNUMERO")) |>
  dplyr::left_join(children_data_3_2018, by = c("HHID", "QSNUMERO", "HIDX"))

# Join children data with mother data_2018
children_mother_data_2018 <- children_data_2018 |>
  dplyr::left_join(woman_data_3_2018, by = c("HHID", "QSNUMERO", "HIDX"))

# Join home data with dwelling data_2018
home_dwelling_data_2018 <- home_data_2018 |>
  dplyr::left_join(dwelling_data_2018, by = "HHID")

# Join children/mother data with individual data_2018
children_mother_individual_data_2018 <- children_mother_data_2018 |>
  dplyr::left_join(individual_data_2018, by = c("HHID","QSNUMERO"))

# Join home/dwelling/individual data with mother data_2018
pre_data_2018 <- children_mother_individual_data_2018 |> 
  dplyr::left_join(woman_data_2018, by = c("HHID", "QSNUMERO"))

# Join home/dwelling/individual/mother data with health data_2018
pre_data_1_2018 <- pre_data_2018 |> 
  dplyr::left_join(health_data_2018, by = c("HHID", "QSNUMERO"))

# Join all_2018
endesdbm_2018 <- pre_data_1_2018 |>
  dplyr::left_join(home_dwelling_data_2018, by = 'HHID')
```

## Join dataframes 2017

```{r}
# Join mother data_2017
woman_data_2017 <- woman_data_1_2017 |>
  dplyr::left_join(woman_data_2_2017, by = c("HHID", "QSNUMERO")) |>
  dplyr::left_join(woman_data_4_2017, by = c("HHID", "QSNUMERO")) |>
  dplyr::left_join(woman_data_5_2017, by = c("HHID", "QSNUMERO"))

# Join children data_2017
children_data_2017 <- children_data_1_2017 |>
  dplyr::full_join(children_data_2_2017, by = c("HHID", "QSNUMERO")) |>
  dplyr::left_join(children_data_3_2017, by = c("HHID", "QSNUMERO", "HIDX"))

# Join children data with mother data_2017
children_mother_data_2017 <- children_data_2017 |>
  dplyr::left_join(woman_data_3_2017, by = c("HHID", "QSNUMERO", "HIDX"))

# Join home data with dwelling data_2017
home_dwelling_data_2017 <- home_data_2017 |>
  dplyr::left_join(dwelling_data_2017, by = "HHID")

# Join children/mother data with individual data_2017
children_mother_individual_data_2017 <- children_mother_data_2017 |>
  dplyr::left_join(individual_data_2017, by = c("HHID","QSNUMERO"))

# Join home/dwelling/individual data with mother data_2017
pre_data_2017 <- children_mother_individual_data_2017 |> 
  dplyr::left_join(woman_data_2017, by = c("HHID", "QSNUMERO"))

# Join home/dwelling/individual/mother data with health data_2017
pre_data_1_2017 <- pre_data_2017 |> 
  dplyr::left_join(health_data_2017, by = c("HHID", "QSNUMERO"))

# Join all_2017
endesdbm_2017 <- pre_data_1_2017 |>
  dplyr::left_join(home_dwelling_data_2017, by = 'HHID')
```

## select variable 2024

```{r}
endesdbm_2024_join <- endesdbm_2024 |>
  dplyr::mutate(year = 2024) |>
  dplyr::select(HHID, HV001, HV022, HV005, V005, HV025, HV040, HV023, SHREGION, HV270, HV271, HV101, HV104, HA1, HV105, HV115, QH25A, HA65, HV109, HA66, HA2, HA3, HA40, HA41, HA53, HA55, HA56, HA57, HA54, V212, M45, M46, M54, M14, M66, M67, M71, V201, V208, M17, QS26, M4, M5, V404, HC1, HC2, HC3, HC4, HC5, HC6, HC7, HC8, HC9, HC10, HC11, HC12, HC13, HC15, HC27, M18, M19, MIDX, HA4, HA5, HA6, HA11, HA12, HA12A, HA12B, HC70, HC71, HC72, HC73, HC53, HC55, HC56, HC56A, HC57, HC57A, HV219, HV220, HV014, HV035, HV103, HV201, HV205, HV206, HV214, HV226, HC60, HC61, HC62, H11, H11B, H22,H31, HW1.x, HW2.x, HW3.x, HW53.x, HW1.y, HW2.y, HW3.y, HW53.y, QSNUMERO, H12A, H12C, H31B, H33, H33D, H33M, H33Y, H34, H35, H40, H40D, H40M, H40Y, H41A, H41B, H42, H43, M13, M19A, M34, M35, M36, M38, M39, M42C,NCONGLOME1) |>
  dplyr::rename(NCONGLOME=NCONGLOME1, HW1_1=HW1.x, HW2_1=HW2.x, HW3_1=HW3.x, HW1_2=HW1.y, HW2_2=HW2.y,
                HW3_2=HW3.y,  HW53_1=HW53.x, HW53_2=HW53.y)

endesdbm_2023_join <- endesdbm_2023 |>
  dplyr::mutate(year=2023) |>
  dplyr::select(HHID, HV001, HV022, HV005, V005, HV025, HV040, HV023, SHREGION, HV270, HV271, HV101, HV104, HA1, HV105, HV115, QH25A, HA65, HV109, HA66, HA2, HA3, HA40, HA41, HA53, HA55, HA56, HA57, HA54, V212, M45, M46, M54, M14, M66, M67, M71, V201, V208, M17, QS26, M4, M5, V404, HC1, HC2, HC3, HC4, HC5, HC6, HC7, HC8, HC9, HC10, HC11, HC12, HC13, HC15, HC27, M18, M19, MIDX, HA4, HA5, HA6, HA11, HA12, HA12A, HA12B, HC70, HC71, HC72, HC73, HC53, HC55, HC56, HC57, HV219, HV220, HV014, HV035, HV103, HV201, HV205, HV206, HV214, HV226, HC60, HC61, HC62, H11, H11B, H22,H31, HW1.x, HW2.x, HW3.x, HW53.x, HW1.y, HW2.y, HW3.y, HW53.y, QSNUMERO, H12A, H12C, H31B, H33, H33D, H33M, H33Y, H34, H35, H40, H40D, H40M, H40Y, H41A, H41B, H42, H43, M13, M19A, M34, M35, M36, M38, M39, M42C, Peso15_amas) |>
  dplyr::rename(PESO15_AMAS=Peso15_amas, HW1_1=HW1.x, HW2_1=HW2.x, HW3_1=HW3.x, HW1_2=HW1.y, HW2_2=HW2.y,
                HW3_2=HW3.y,  HW53_1=HW53.x, HW53_2=HW53.y)
  
endesdbm_2022_join <- endesdbm_2022 |>
  dplyr::mutate(year=2022) |>
  dplyr::select(HHID, HV001, HV022, HV005, V005, HV025, HV040, HV023, SHREGION, HV270, HV271, HV101, HV104, HA1, HV105, HV115, QH25A, HA65, HV109, HA66, HA2, HA3, HA40, HA41, HA53, HA55, HA56, HA57, HA54, V212, M45, M46, M54, M14, M66, M67, M71, V201, V208, M17, QS26, M4, M5, V404, HC1, HC2, HC3, HC4, HC5, HC6, HC7, HC8, HC9, HC10, HC11, HC12, HC13, HC15, HC27, M18, M19, MIDX, HA4, HA5, HA6, HA11, HA12, HA12A, HA12B, HC70, HC71, HC72, HC73, HC53, HC55, HC56, HC57, HV219, HV220, HV014, HV035, HV103, HV201, HV205, HV206, HV214, HV226, HC60, HC61, HC62, H11, H11B, H22,H31, HW1.x, HW2.x, HW3.x, HW53.x, HW1.y, HW2.y, HW3.y, HW53.y, QSNUMERO, H12A, H12C, H31B, H33, H33D, H33M, H33Y, H34, H35, H40, H40D, H40M, H40Y, H41A, H41B, H42, H43, M13, M19A, M34, M35, M36, M38, M39, M42C) |>
  rename(HW1_1=HW1.x, HW2_1=HW2.x, HW3_1=HW3.x, HW1_2=HW1.y, HW2_2=HW2.y,
                HW3_2=HW3.y,  HW53_1=HW53.x, HW53_2=HW53.y)
...
endesdbm_2019_join <- endesdbm_2019 |>
  dplyr::mutate(year=2019) |>
  dplyr::select(HHID, HV001, HV022, HV005, V005, HV025, HV040, HV023, SHREGION, HV270, HV271, HV101, HV104, HA1, HV105, HV115, QH25A, HA65, HV109, HA66, HA2, HA3, HA40, HA41, HA53, HA55, HA56, HA57, HA54, V212, M45, M46, M54, M14, M66, M67, M71, V201, V208, M17, QS26, M4, M5, V404, HC1, HC2, HC3, HC4, HC5, HC6, HC7, HC8, HC9, HC10, HC11, HC12, HC13, HC15, HC27, M18, M19, MIDX, HA4, HA5, HA6, HA11, HA12, HA12A, HA12B, HC70, HC71, HC72, HC73, HC53, HC55, HC56, HC57, HV219, HV220, HV014, HV035, HV103, HV201, HV205, HV206, HV214, HV226, HC60, HC61, HC62, H11, H11B, H22,H31, HW1.x, HW2.x, HW3.x, HW53.x, HW1.y, HW2.y, HW3.y, HW53.y, QSNUMERO, H12A, H12C, H31B, H33, H33D, H33M, H33Y, H34, H35, H40, H40D, H40M, H40Y, H41A, H41B, H42, H43, M13, M19A, M34, M35, M36, M38, M39, M42C) |>
  rename(HW1_1=HW1.x, HW2_1=HW2.x, HW3_1=HW3.x, HW1_2=HW1.y, HW2_2=HW2.y,
                HW3_2=HW3.y,  HW53_1=HW53.x, HW53_2=HW53.y)

endesdbm_2018_join <- endesdbm_2018 |>
  dplyr::mutate(year=2018) |>
  dplyr::select(HHID, HV001, HV022, HV005, V005, HV025, HV040, HV023, SHREGION, HV270, HV271, HV101, HV104, HA1, HV105, HV115, QH25A, HA65, HV109, HA66, HA2, HA3, HA40, HA41, HA53, HA55, HA56, HA57, HA54, V212, M45, M46, M54, M14, M66, M67, M71, V201, V208, M17, QS26, M4, M5, V404, HC1, HC2, HC3, HC4, HC5, HC6, HC7, HC8, HC9, HC10, HC11, HC12, HC13, HC15, HC27, M18, M19, MIDX, HA4, HA5, HA6, HA11, HA12, HA12A, HA12B, HC70, HC71, HC72, HC73, HC53, HC55, HC56, HC57, HV219, HV220, HV014, HV035, HV103, HV201, HV205, HV206, HV214, HV226, HC60, HC61, HC62, H11, H11B, H22,H31, HW1.x, HW2.x, HW3.x, HW53.x, HW1.y, HW2.y, HW3.y, HW53.y, QSNUMERO, H12A, H12C, H31B, H33, H33D, H33M, H33Y, H34, H35, H40, H40D, H40M, H40Y, H41A, H41B, H42, H43, M13, M19A, M34, M35, M36, M38, M39, M42C) |>
  rename(HW1_1=HW1.x, HW2_1=HW2.x, HW3_1=HW3.x, HW1_2=HW1.y, HW2_2=HW2.y,
                HW3_2=HW3.y, HW53_1=HW53.x, HW53_2=HW53.y)

endesdbm_2017_join <- endesdbm_2017 |>
  dplyr::mutate(year=2017) |>
  dplyr::select(HHID, HV001, HV022, HV005, V005, HV025, HV040, HV023, SHREGION, HV270, HV271, HV101, HV104, HA1, HV105, HV115, HA65, HV109, HA66, HA2, HA3, HA40, HA41, HA53, HA55, HA56, HA57, HA54, V212, M45, M46, M54, M14, M66, M67, M71, V201, V208, M17, QS26, M4, M5, V404, HC1, HC2, HC3, HC4, HC5, HC6, HC7, HC8, HC9, HC10, HC11, HC12, HC13, HC15, HC27, M18, M19, MIDX, HA4, HA5, HA6, HA11, HA12, HA12A, HA12B, HC70, HC71, HC72, HC73, HC53, HC55, HC56, HC57, HV219, HV220, HV014, HV035, HV103, HV201, HV205, HV206, HV214, HV226, HC60, HC61, HC62, H11, H11B, H22,H31, HW1.x, HW2.x, HW3.x, HW53.x, HW1.y, HW2.y, HW3.y, HW53.y, QSNUMERO, H12A, H12C, H31B, H33, H33D, H33M, H33Y, H34, H35, H40, H40D, H40M, H40Y, H41A, H41B, H42, H43, M13, M19A, M34, M35, M36, M38, M39, M42C) |>
  rename(HW1_1=HW1.x, HW2_1=HW2.x, HW3_1=HW3.x, HW1_2=HW1.y, HW2_2=HW2.y,
                HW3_2=HW3.y, HW53_1=HW53.x, HW53_2=HW53.y)
```
...
test <- bind_rows(endesdbm_2024_join, endesdbm_2023_join, endesdbm_2022_join, endesdbm_2020_join, endesdbm_2019_join, endesdbm_2018_join, endesdbm_2017_join)
...
haven::write_dta(test, here::here("data", "clean", "endes_2024-2018.dta"))
```
